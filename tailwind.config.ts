  ...
  theme: {
    extend: {
      colors: {
        ...
        gold: "rgb(var(--text-dim-rgb) / <alpha-value>)",
        "gold-dim": "rgb(var(--text-dimmer-rgb) / <alpha-value>)",
        line: "var(--line)",
      ...
      backgroundImage: {
        ...
        "hero-glow":
          "radial-gradient(ellipse 70% 50% at 50% -10%, rgba(59,130,246,0.18), transparent 60%)",
      },
    },
  },
  plugins: [],
